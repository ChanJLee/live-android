        ...
        mRecordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isRecording) {
                    ...
                    Toast.makeText(LiveActivity.this, "stop living", Toast.LENGTH_SHORT).show();
    ...
    private void initRtmpAddressDialog() {
        ...
        okBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(LiveActivity.this, "start connecting", Toast.LENGTH_SHORT).show();
...
//		mLFLiveView.setWatermark(watermark);
        ...
        //设置手势识别
        mGestureDetector = new GestureDetector(this, new LiveActivity.GestureListener());
        ...
        mLFLiveView.setLivingStartListener(new CameraLivingView.LivingStartListener() {
            ...
            public void startSuccess() {
                //直播成功
                Toast.makeText(LiveActivity.this, "start living", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private RtmpSender.OnSenderListener mSenderListener = new RtmpSender.OnSenderListener() {
        ...
        public void onDisConnected() {
            mProgressConnecting.setVisibility(View.GONE);
            Toast.makeText(LiveActivity.this, "fail to live", Toast.LENGTH_SHORT).show();
            //mRecordBtn.setBackgroundResource(R.mipmap.ic_record_start);
            mLFLiveView.stop();
            isRecording = false;
        }
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (e1.getX() - e2.getX() > 100
                ...
                // Fling left
                Toast.makeText(LiveActivity.this, "Fling Left", Toast.LENGTH_SHORT).show();
            } else if (e2.getX() - e1.getX() > 100
                    && Math.abs(velocityX) > 200) {
                // Fling right
                Toast.makeText(LiveActivity.this, "Fling Right", Toast.LENGTH_SHORT).show();
            }
